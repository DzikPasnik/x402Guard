...
export const metadata: Metadata = {
  ...
  description:
    "Complete documentation for x402Guard: API reference, quick start guide, TypeScript SDK, ElizaOS plugin, Virtuals integration, guardrail configuration, session key management, and Solana vault setup.",
  keywords: [
